...
router.post('/agregar', isLoggedIn, async(request, response) => { 
    const { accion, idestudiante, nombre,apellido, email, idcarrera, usuario } = 
request.body; 
    const nuevoEstudiante = { idestudiante, nombre, apellido, email, idcarrera, 
usuario }; 
...
router.get('/modificar/:idestudiante', isLoggedIn, async(request, response) => { 
    ...
    response.render('estudiantes/actualizar', {lstCarreras, idestudiante, 
estudiante}); 
}); 
...
router.post('/modificar/:id', isLoggedIn, async(request, response) => { 
    ...
    const {  idestudiante, nombre,apellido, email, idcarrera, usuario } = 
request.body; 
    const nuevoEstudiante = { idestudiante, nombre, apellido, email, idcarrera, 
usuario }; 
 
    const actualizacion = await queries.actualizarEstudiante(id, 
nuevoEstudiante); 
